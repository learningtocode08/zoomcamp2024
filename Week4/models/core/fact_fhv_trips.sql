...
select
    ...
    ,fhv_tripdata.service_type as service_type
    ,fhv_tripdata.pickup_datetime as pickup_datetime
    ,fhv_tripdata.dropoff_datetime as dropoff_datetime
    ,fhv_tripdata.pulocationid as pulocationid
    ,pickup_zone.borough as pickup_borough 
    ,pickup_zone.zone as pickup_zone 
    ,fhv_tripdata.dolocationid as dolocationid
...
where extract(year from date(fhv_tripdata.pickup_datetime)) = 2019
